...
const NewListing = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (!formData.title || !formData.description || !formData.country || !formData.location) {
        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-50">
            <div className="w-full max-w-2xl bg-white p-8 rounded-lg shadow-md">
                ...
                <form id="new-listing-form" onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="urlImage" className="block text-sm font-medium text-gray-700">Image URL</label>
                        <input
                            type="text"
                            name="urlImage"
                            id="urlImage"
                    ...
                    <button type="submit" className="w-full bg-rose-500 text-white py-3 rounded-md hover:bg-rose-600 transition-colors">
                        Add to List
                    </button>
                </form>
            </div>
