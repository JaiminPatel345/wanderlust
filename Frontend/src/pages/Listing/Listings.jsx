...
const Listings = () => {
    const { filterListings, allListings, filterListingsOnTag, searchResults, searchListingsBackend } =
        useListingStore()
            ...
            {isSearchResults && (
                <div className="mb-4 bg-gray-50 p-4 rounded-lg flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <span className="ml-2 text-gray-500">({filterListings.length} listings found)</span>
                    </div>
                    <button 
                        onClick={() => {
            ...
            <div className="flex flex-col mb-4">
                {!isSearchResults && (
                    <div className="w-full overflow-hidden mb-4">
                        ...
                        <div className="flex items-center overflow-x-auto pb-2 no-scrollbar -mx-4 px-4 touch-pan-x">
